...
public class ExamString2 {
	...
	public static void main(String[] args) {
		//생년월일부터 오늘까지 몇일 경과?
		LocalDate startDate1 = LocalDate.of(1995,4,4);
		LocalDate endDate1 = LocalDate.of(2024,12,25);
		long remainDay1 = startDate1.until(endDate1, ChronoUnit.DAYS);
		System.out.println("내 생일부터 오늘까지 : " + remainDay1 + "일 경과");
		...
		System.out.println("수료까지 남은 일수 : " + remainDay2);
